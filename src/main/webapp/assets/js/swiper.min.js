...
!(function (e, t) {
  ...
  var o = {
    ...
    updateSlides: function () {
      ...
      if (void 0 !== i) {
        ...
        for (
          var E, S = t.slidesPerColumn, C = x / S, M = C - (t.slidesPerColumn * C - d), k = 0;
          k < d;
          k += 1
        ) {
          T = 0;
  ...
  var h = {
    setGrabCursor: function (e) {
      if (
        !(R.touch || !this.params.simulateTouch || (this.params.watchOverflow && this.isLocked))
      ) {
        var t = this.el;
        (t.style.cursor = 'move'),
  ...
  var b = {
    attachEvents: function () {
        ...
        (e.onTouchEnd = function (e) {
          ...
          if (
            ...
            if (u > i.longSwipesMs) {
              ...
              'next' === t.swipeDirection &&
                (P >= i.longSwipesRatio ? t.slideTo(M + i.slidesPerGroup) : t.slideTo(M)),
                'prev' === t.swipeDirection &&
      ...
      (t.preventClicks || t.preventClicksPropagation) && r.addEventListener('click', e.onClick, !0),
        e.on(
          m.ios || m.android ? 'resize orientationchange observerUpdate' : 'resize observerUpdate',
          g,
          !0,
        );
    },
    ...
    D = {
      update: function (e) {
        ...
        for (var k = 0; k < u.length; k += 1)
          y <= k &&
            k <= x &&
            (void 0 === c || e ? C.push(k) : (c < k && C.push(k), k < p && S.push(k)));
  ...
  return (
    void 0 === S.use && ((S.use = S.Class.use), (S.installModule = S.Class.installModule)),
    S.use(ie),
    S
  );
});
