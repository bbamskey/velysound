...
public class NumberUtil {
	 ...
	 * @see
	 */
	public static String decimalFmt(double value) {
	 ...
	 * @return
	 */
	public static double roundup(double d, double value) {
		if (Double.isInfinite(d) || Double.isNaN(d)) {
			return 0;
		}
		double result = (Math.round(d * 10 * value));
	 ...
	 * @see
	 */
	public static String decimalFmt(String value) {
		return decimalFmt(Double.parseDouble(value));
	}
}
