...
public class DateStringUtil {
	...
	public static String addYearMonthDay(int year, int month, int day, String format) {
	 ...
	 */
	public static int getMonthsDiff(String dateStr1, String dateStr2) throws ParseException {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd", Locale.getDefault());
	...
	/**
	 * <p>yyyyMMddHHmm 형식의 날짜 문자열 <code>dateStr1</code>과 <code>
	 * dateStr2</code> 사이의 시간차이를 구한다.<br>
	 * <code>dateStr2</code>가 <code>dateStr1</code> 보다 과거 날짜일 경우에는
	 * 음수를 반환한다. 동일한 경우에는 0을 반환한다.</p>
	 *
	 * @param dateStr1 날짜 문자열(yyyyMMddHHmm의 형식)
	 * @param dateStr2 날짜 문자열(yyyyMMddHHmm의 형식)
	 * @return 일 수 차이.
	 * @throws IllegalArgumentException 날짜 포맷이 정해진 바와 다를 경우.
	 *                                  입력 값이 <code>null</code>인 경우.
	 */
	public static int getHoursDiff(String dateStr1, String dateStr2) {
		...
		if (date1 != null && date2 != null) {
			int hours1 = (int) (date1.getTime() / 3600000);
			int hours2 = (int) (date2.getTime() / 3600000);
	 ...
	 *                                  입력 값이 <code>null</code>인 경우.
	 */
	public static int getMinutesDiff(String dateStr1, String dateStr2) {
		...
		if (date1 != null && date2 != null) {
			int minutes1 = (int) (date1.getTime() / 60000);
			int minutes2 = (int) (date2.getTime() / 60000);
	 ...
	 * @return
	 */
	public static String yesterdayWeek() {
		String[] weekDay = {"일요일", "월요일", "화요일", "수요일", "목요일", "금요일", "토요일"};
	 ...
	 * @throws Exception
	 */
	public static int getDateDayInt(String date, String dateType) throws ParseException {
	...
	public static String getPlusMinuteToFormatString(Date date, int mm, String format) {

		Calendar ca = Calendar.getInstance();
		ca.setTimeInMillis(date.getTime());
		ca.add(Calendar.MINUTE, mm);
		String strDate = DateStringUtil.getDateToFormatString(ca.getTime(), format);

		return strDate;

	}

	public static String getPlusHourToFormatString(Date date, int hh, String format) {
	...
	public static String getPlusDateToFormatString(Date date, int dd, String format) {

		Calendar ca = Calendar.getInstance();
		ca.setTimeInMillis(date.getTime());
		ca.add(Calendar.DATE, dd);
		String strDate = DateStringUtil.getDateToFormatString(ca.getTime(), format);
	...
	public static String getPlusMonthToFormatString(Date date, int MM, String format) {

		Calendar ca = Calendar.getInstance();
		ca.setTimeInMillis(date.getTime());
		ca.add(Calendar.MONTH, MM);
		String strDate = DateStringUtil.getDateToFormatString(ca.getTime(), format);
